...
/** Mnemonic key type */
export declare enum MnemonicType {
    Mnemonic = "Mnemonic"
}
/** Key type */
export type KeyType = Secp256k1 | Bls | Ed25519 | MnemonicType;
...
export declare class Key {
     ...
     */
    static deriveKeys(cs: CubeSigner, orgId: string, keyType: KeyType, derivationPaths: string[], mnemonicId: string, ownerId?: string): Promise<Key[]>;
    /** Get a key by id.
     * @param {CubeSigner} cs The CubeSigner instance to use for signing.
     * @param {string} orgId The id of the organization to which the key belongs.
