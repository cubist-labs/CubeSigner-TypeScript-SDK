...
export interface components {
    schemas: {
        ...
        /**
         * @description Approval info, containing:
         * (1) the user who approved
         * (2) the MFA method used for approval
         * (3) the timestamp of approval
         *
         * For equality and ordering checks, we only use the `user` field to prevent the
         * same user approving multiple times.
         *
         * For ordering, we use the `timestamp` field followed by `user
         * (because timestamps are not guaranteed to be different).
         */
        ApprovedBy: {
            mfa_type: components["schemas"]["MfaType"];
        ...
        Status: {
            /**
             * @description Users who are allowed to approve.  When omitted, any user
             * (who has access to the corresponding role) can approve.
             */
            ...
            approved_by: components["schemas"]["ApprovedBy"][];
            /**
             * Format: int32
