import { OrgEventProcessor, OrgEventMessage, SubscriptionConfirmationMessage } from "../src/index";
...
describe("Org event processor", () => {
  const orgId = "Org#06aadcc8-1669-4cb5-a129-a293de388b70";
  ...
  it("parse valid event", async () => {
    ...
    expect(event.org_event).toEqual("OidcAuth");
  });
