...
import { MfaRequestInfo, OrgInfo, PublicKeyCredential, RatchetConfig, UpdateKeyProperties } from "./schema_types";
...
export declare class CubeSignerClient extends CubeSignerApi {
     ...
     */
    createKey(type: KeyType, ownerId?: string, props?: UpdateKeyProperties): Promise<Key>;
    /**
