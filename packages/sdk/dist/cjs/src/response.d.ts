...
export declare class CubeSignerResponse<U> {
     ...
     */
    execWithMfaApproval(mfaReceipt: MfaReceipt): Promise<CubeSignerResponse<U>>;
    /**
     * Constructor.
     ...
     * @internal
     */
    static create<U>(env: EnvInterface, requestFn: RequestFn<U>, mfaReceipt?: MfaReceipt): Promise<CubeSignerResponse<U>>;
    /**
