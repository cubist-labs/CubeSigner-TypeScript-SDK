...
class CubeSignerClient {
    ...
    static async createOidcSession(env, orgId, token, scopes, lifetimes, mfaReceipt) {
        return await api_client_1.ApiClient.oidcSessionCreate(env, orgId, token, scopes, lifetimes, mfaReceipt);
    }
    /**
