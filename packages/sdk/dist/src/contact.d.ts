import type { AddressMap, ApiClient, CubeSignerResponse, EditPolicy, Empty, JsonValue, MfaReceipts } from "./index.ts";
...
export declare class Contact {
     ...
     */
    labels(): Promise<ContactLabel[] | undefined>;
    /**
     * @param labels The new labels that the contact should hold
     */
    setLabels(labels: ContactLabel[]): Promise<void>;
    /**
