import { type MultiRegionEnv, type EnvInterface, type PasskeyAssertChallenge, type schemas, type SessionData } from "./index.ts";
/**
...
export declare class PasskeyLoginChallenge {
     ...
     */
    constructor(env: EnvInterface | MultiRegionEnv, challenge: PasskeyAssertChallenge, purpose: string | null | undefined);
    /**
