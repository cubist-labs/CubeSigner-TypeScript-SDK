import type { KeyType, KeyProperties, NotificationEndpointConfiguration, PageOpts, UserInOrgInfo, ApiClient, OrgInfo, MfaId, ImportKeyRequest, KeyPolicy, QueryMetricsResponse, OrgMetricName, QueryMetricsRequest, KeyTypeAndDerivationPath } from ".";
...
export declare class Org {
     ...
     */
    queryMetrics(metricName: OrgMetricName, startTime: EpochTimeStamp, opt?: Omit<QueryMetricsRequest, "metric_name" | "start_time">): Promise<QueryMetricsResponse>;
    /**
