...
export declare class Org {
     ...
     */
    queryAuditLog(startTime: EpochTimeStamp, opt?: Omit<AuditLogRequest, "start_time">, pageOpts?: PageOpts): Promise<AuditLogEntry[]>;
    /**
     ...
     * @param policy The new policy for the org.
     */
    setSignPolicy(policy: RolePolicy): Promise<void>;
    /**
    ...
    get createUser(): {
        ...
        (email: string, name: string, role?: import("./schema_types").MemberRole, skipEmail?: boolean): Promise<void>;
    };
    /**
     ...
     */
    createPolicy<Type extends "Key" | "Role">(name: string, type: Type, rules: Type extends "Key" ? KeyPolicy : RolePolicy, acl?: PolicyAcl): Promise<Type extends "Key" ? NamedKeyPolicy : NamedRolePolicy>;
    /**
     ...
     */
    getFunction(functionId: string): Promise<C2FFunction>;
    /**
     ...
     */
    policies(page?: PageOpts, policyType?: PolicyType): Promise<NamedPolicy[]>;
    /**
     ...
     */
    functions(page?: PageOpts): Promise<C2FFunction[]>;
    /**
     ...
     * @returns The C2F function
     */
    createWasmFunction(name: string, policy: Uint8Array, acl?: PolicyAcl): Promise<C2FFunction>;
    /** @returns the Confidential Cloud Functions configuration for the org. */
    c2fConfiguration(): Promise<C2FConfiguration | undefined>;
    /**
     ...
     */
    setC2FConfiguration(configs: C2FConfiguration): Promise<void>;
    /**
     ...
     */
    createContact(name: string, addresses?: AddressMap, metadata?: JsonValue, editPolicy?: EditPolicy, labels?: ContactLabel[]): Promise<Contact>;
    /**
     ...
     */
    contacts(search?: `label${ContactLabel}` | ContactAddressData | string): Promise<Contact[]>;
    /**
     ...
     * @returns The new policy.
     */
    createWasmPolicy: (name: string, policy: Uint8Array, acl?: PolicyAcl) => Promise<C2FFunction>;
    /** @returns the Policy Engine configuration for the org. */
    policyEngineConfiguration: () => Promise<C2FConfiguration | undefined>;
    /**
     ...
     */
    setPolicyEngineConfiguration: (configs: C2FConfiguration) => Promise<void>;
}
