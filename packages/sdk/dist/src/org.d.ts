import type { KeyType, KeyProperties, NotificationEndpointConfiguration, PageOpts, UserInOrgInfo, ApiClient, OrgInfo, MfaId, ImportKeyRequest } from ".";
...
export declare class Org {
     ...
     */
    get getKeyImportKey(): () => Promise<import("./schema_types").CreateKeyImportKeyResponse>;
    /**
