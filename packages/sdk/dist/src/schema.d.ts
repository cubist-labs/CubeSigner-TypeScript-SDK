...
export interface components {
    schemas: {
         ...
         * @enum {string}
         */
        MfaProtectedAction: "Default" | "Login" | "ExtendSession" | "AddIdentity" | "KeyExport";
