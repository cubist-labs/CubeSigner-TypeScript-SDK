...
export interface paths {
    ...
    "/v0/org/{org_id}/contacts/by-address": {
         ...
         * defined.
         */
        post: operations["lookupContactsByAddress"];
    };
    ...
    "/v0/org/{org_id}/users/reset_mfa": {
         ...
         */
        patch: operations["completeResetMemberMfa"];
    };
...
export interface components {
    schemas: {
        ...
        /** @description The addresses associated with a contact. */
        AddressMap: {
        ...
        BitcoinAddressInfo: {
             ...
             */
            address: string;
            chain: components["schemas"]["BtcChain"];
        };
        /**
         * @example {
        ...
        CompleteMfaResetRequest: {
            /**
             * @description The reset token emailed to the user
             * @example User#c3b9379c-4e8c-4216-bd0a-65ace53cf98f
             */
            token: string;
        };
        ...
        ContactAddressData: (components["schemas"]["BitcoinAddressInfo"] & {
            /** @enum {string} */
            network: "Bitcoin";
        }) | (components["schemas"]["EvmAddressInfo"] & {
            /** @enum {string} */
            network: "Evm";
        ...
        Event: {
            event: "Event";
        } & Omit<components["schemas"]["EventData"], "event"> & {
            /** @description Unique identifier of an event. */
            event_id?: string;
            org: components["schemas"]["Id"];
            /** @description The origin header of the request that triggered this event */
            origin?: string;
            /** @description The ID of the request that triggered this event */
            request_id?: string;
            /**
             * Format: int64
        ...
        /**
         * @description Data associated with an event. Depending on the event type (i.e., billing or org event),
         * different fields are used.
         */
        EventData: (components["schemas"]["BillingArgs"] & {
            /** @enum {string} */
            event: "cubist::billing";
        }) | (components["schemas"]["OrgEventArgs"] & {
            /** @enum {string} */
            event: "cubist::org_event";
        });
        /** @description An EVM address and its chain. */
        EvmAddressInfo: {
            /**
             * @description The EVM address.
             * @example 0x52f6c0b306e66893c0414abb70951c4dac15a969
             */
            address: string;
            /**
             * @description The EVM chain this address belongs to **as a hex string**. The string
         ...
         * @enum {string}
         */
        MfaProtectedAction: "Default" | "RegisterMfa" | "Login" | "ExtendSession" | "AddIdentity" | "KeyExport";
        ...
        /** @description Represents the data extracted from the OIDC token */
        OidcClaims: components["schemas"]["OidcUserInfo"] & components["schemas"]["OidcIdentity"] & {
            /**
             * @description Audience(s) that this ID Token is intended for. It MUST contain the
             ...
             */
            aud: string;
            /** @description An optional restriction on the set of scopes allowed with this token */
            cubesigner_scope_ceiling?: components["schemas"]["Scope"][] | null;
        };
        /**
        ...
        OrgEventArgs: {
            org_event: "OrgEventArgs";
        } & Omit<components["schemas"]["OrgEventData"], "org_event"> & {
            /** @description The identity that triggered the event */
            triggered_by: string;
        };
        /** @description Org-level events that we notify our customers about */
        OrgEventData: {
            billing_event: components["schemas"]["BillingEvent"];
            key?: components["schemas"]["Id"] | null;
            /** @enum {string} */
            org_event: "Billing";
            role?: components["schemas"]["Id"] | null;
            ...
            purpose?: string | null;
            scopes: components["schemas"]["Scope"][];
            user_info: components["schemas"]["OidcClaims"];
        } | {
            /** @description The material id (address) of the key used for signing */
            ...
            chain_id: components["schemas"]["Id"];
            key_id: components["schemas"]["Id"];
            /** @enum {string} */
            org_event: "BabylonEotsConcurrentSigning";
            /** Format: int64 */
            prev_block_height: number;
            prev_signing_hash: string;
            /** Format: int64 */
            req_block_height: number;
            req_signing_hash: string;
        } | {
            attestation: {
                /** @description The hash that was signed */
                signing_root: string;
                /**
                 * Format: int64
            ...
            /** @enum {string} */
            org_event: "Eth2ConcurrentAttestationSigning";
        } | {
            block: {
                /** @description The hash that was signed */
                signing_root: string;
            ...
            material_id?: string | null;
            /** @enum {string} */
            org_event: "Eth2ConcurrentBlockSigning";
        } | {
            enforced: boolean;
            last_signing_root: string;
            /** Format: int64 */
            last_slot: number;
            /** @enum {string} */
            org_event: "Eth2InvalidBlockProposerSlotTooLow";
            signing_root: string;
            /** Format: int64 */
            slot: number;
        } | {
            ...
            last_signing_root: string;
            /** Format: int64 */
            last_target_epoch: number;
            /** @enum {string} */
            org_event: "Eth2InvalidAttestationSourceEpochTooLow";
            signing_root: string;
            /** Format: int64 */
            source_epoch: number;
        } | {
            ...
            last_target_epoch: number;
            /** @enum {string} */
            org_event: "Eth2InvalidAttestationTargetEpochTooLow";
            signing_root: string;
            /** Format: int64 */
            target_epoch: number;
        } | {
            /** Format: int32 */
            daily_unstake_count: number;
            key_id: components["schemas"]["Id"];
            /** @enum {string} */
            org_event: "Eth2Unstake";
            pubkey: string;
            /** Format: int64 */
            ...
            max: number;
            /** @enum {string} */
            org_event: "Eth2ExceededMaxUnstake";
        } | {
            /** @description Key ids */
            key_ids: string[];
            key_type: components["schemas"]["KeyType"];
            /** @enum {string} */
            org_event: "KeyCreated";
            owner_id: components["schemas"]["Id"];
        } | {
            mfa_request: components["schemas"]["MfaRequestInfo"];
            /** @enum {string} */
            org_event: "MfaRejected";
            rejected_by: components["schemas"]["Id"];
            rejected_mfa_id?: components["schemas"]["Id"] | null;
            rejected_with_mfa_type: components["schemas"]["MfaType"];
        } | {
            changed_by: components["schemas"]["Id"];
            /** @description The new policy */
            new_policy: unknown[];
            /** @enum {string} */
            org_event: "PolicyChanged";
        } | {
            /** @description Chain id */
            chain_id: string;
            /** @description The state of the current request */
            current_state: unknown;
            key_id: components["schemas"]["Id"];
            /** @description The state of the last signed message */
            last_state: unknown;
            /** @enum {string} */
            ...
            key_id: components["schemas"]["Id"];
            /** @enum {string} */
            org_event: "UserExportInit";
            valid_epoch: components["schemas"]["EpochDateTime"];
        } | {
            key_id: components["schemas"]["Id"];
            /** @enum {string} */
            org_event: "UserExportComplete";
        } | {
            /** @description The error from the policy engine (when response is equal to 'Error') */
            error?: string | null;
            key_id: components["schemas"]["Id"];
            /** @enum {string} */
            org_event: "WasmPolicyExecuted";
            /** @description Policy name or id */
            policy: string;
            /** @description Policy hash */
            policy_hash: string;
            /** @description The reason for the denial (when response is equal to 'Deny') */
            reason?: string | null;
            /**
             * @description Auto-generated discriminant enum variants
             * @enum {string}
             */
            response: "Allow" | "Deny" | "Error";
            /**
             * @description The source of a policy execution, i.e. the reason it was executed.
             * @enum {string}
             */
            source: "SignRequest" | "UserInvocation";
            /** @description Policy error output */
            stderr: string;
            /** @description Policy standard output */
            stdout: string;
        };
        /**
         * @description Auto-generated discriminant enum variants
        ...
        PaginatedListContactsResponse: {
            /** @description A list of contacts in the organization, matching any provided queries. */
            contacts: components["schemas"]["ContactInfoResponse"][];
        } & {
            /**
             * @description If set, the content of `response` does not contain the entire result set.
             * To fetch the next page of the result set, call the same endpoint
        ...
        /** @enum {string} */
        Purpose: "otp" | "mfa_reset" | "otp_mfa" | "alien_password_reset" | "alien_invite";
        ...
        SessionInfo: components["schemas"]["SessionMetadata"] & {
            /**
             * Format: int64
             * @description Creation date (in seconds since unix epoch)
             */
            created_at: number;
            /**
             * Format: int64
             ...
             */
            exp: number;
            last_used?: components["schemas"]["WhereAndWhen"] | null;
            lifetimes?: components["schemas"]["RatchetConfig"];
            /**
        ...
        SuiAddressInfo: {
             ...
             */
            address: string;
            chain: components["schemas"]["SuiChain"];
        };
        /**
        ...
        UpdateContactRequest: {
            ...
            metadata?: unknown;
            /**
             * @description A new name for the contact. Must be a unique name among contacts in the
             * org. Name must consist of alphanumeric characters, spaces, `.` and `-`,
             * and cannot be longer than 50 characters.
             * @example Satoshi Nakamoto
             */
...
export interface operations {
    ...
    createContact: {
        ...
        responses: {
            200: components["responses"]["ContactInfoResponse"];
            default: {
                content: {
                    "application/json": components["schemas"]["ErrorResponse"];
                };
    ...
    lookupContactsByAddress: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ContactAddressData"];
            };
        };
        responses: {
            200: components["responses"]["PaginatedListContactsResponse"];
    ...
    completeResetMemberMfa: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CompleteMfaResetRequest"];
            };
        };
        responses: {
            200: components["responses"]["EmptyImpl"];
