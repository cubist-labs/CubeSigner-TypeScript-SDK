...
export interface components {
    schemas: {
        ...
        QueryMetricsRequest: {
            ...
            metric_name: components["schemas"]["OrgMetricDiscriminants"];
            /**
             * Format: int64
        ...
        QueryMetricsResponse: {
            ...
            stat: components["schemas"]["OrgMetricStat"];
        };
        RatchetConfig: {
            /**
             * Format: int64
...
export interface operations {
    ...
    queryMetrics: {
        ...
        responses: {
            200: components["responses"]["QueryMetricsResponse"];
            default: {
                content: {
                    "application/json": components["schemas"]["ErrorResponse"];
                };
