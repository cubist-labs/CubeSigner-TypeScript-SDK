...
export interface components {
    schemas: {
        ...
        BillingDimensions: {
            /** @description The kind of billing event */
            kind: string;
         ...
         * @enum {string}
         */
        OrgMetricDiscriminants: "BillingEvent" | "OidcLoginEvent" | "SignEvent";
        /**
        ...
        QueryMetricsRequest: {
             ...
             * Must be no less than 1 hour, i.e., 3600 seconds. Also, this period must not
        ...
        QueryMetricsResponse: {
            ...
            messages?: string[];
            period: components["schemas"]["Seconds"];
