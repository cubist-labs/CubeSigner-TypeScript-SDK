...
export interface components {
    schemas: {
        ...
        InvokePolicyRequest: {
            /**
             * @description An optional Key ID. If defined, the policy will be invoked as if it is signing
        ...
        OrgEventData: {
            ...
            method: string;
            operation: components["schemas"]["BillingEvent"];
            /** @enum {string} */
            org_event: "Response";
            /**
             * Format: int32
             ...
             */
            status: number;
            /** @description The HTTP request path + query parameters */
            uri: string;
        } | {
            ...
            error?: string | null;
            key_id?: components["schemas"]["Id"] | null;
            /** @enum {string} */
         ...
         * @enum {string}
         */
        TsQueryName: "ActiveKeys" | "ActiveUsers" | "UniqueSignIns" | "UserCount" | "LatestUserCount" | "KeyCount" | "LatestKeyCount" | "BillingEvents" | "OidcLogins" | "SignEvents";
