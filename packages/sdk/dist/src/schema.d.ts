...
export interface components {
    schemas: {
         ...
         * @enum {string}
         */
        ContactLabel: "cubist:erc20_token";
        ...
        /** @description Information about a currency used on an EVM chain. */
        EvmCurrencyInfo: {
            /**
             * Format: int32
             * @description The number of decimals this currency uses.
             * @example 18
             */
            decimals: number;
            /**
            ...
            name: string;
            /**
             * @description The symbol for the currency, typically a three letter string.
             * @example ETH
             */
            symbol: string;
        };
        ...
        OrgEventData: {
            ...
            approved_with_mfa_type: components["schemas"]["MfaType"];
            mfa_request: components["schemas"]["MfaRequestInfo"];
            /** @enum {string} */
            org_event: "MfaApproved";
        } | {
            mfa_request: components["schemas"]["MfaRequestInfo"];
            /** @enum {string} */
         ...
         *
         * Either `value` or `acl` must be provided.
         */
        SetPolicySecretRequest: {
            /**
             * @description The secret's access-control entries.
