...
export interface components {
    schemas: {
        ...
        /** @enum {string} */
        Purpose: "Otp" | "AlienPasswordReset" | "AlienInvite";
        RatchetConfig: {
