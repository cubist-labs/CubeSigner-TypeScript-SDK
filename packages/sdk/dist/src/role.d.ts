...
export type KeyDenyPolicy = OperationAllowlist | TxReceiver | TxDeposit | TxValueLimit | TxGasCostLimit | IfErc20Tx | AssertErc20Tx | AssertTransferOnlyTx | AssertContractTx | SuiTxReceivers | BtcTxReceivers | SourceIpAllowlist | TimeLock | SolanaInstructionPolicy | BtcSegwitValueLimit | RequireMfa | RequireRoleSession | BabylonStaking | WebhookPolicy | PolicyAnd | PolicyOr | PolicyNot | NamedPolicyReference;
/**
 * Key policy
 *
 * @example [
