import type { ApiClient, ContractAddress, EvmTxCmp, SolanaTxCmp, KeyWithPoliciesInfo, MfaType, PageOpts, RoleInfo, Scope, SessionData, SessionLifetime } from ".";
...
export type KeyDenyPolicy = TxReceiver | TxDeposit | TxValueLimit | TxGasCostLimit | IfErc20Tx | AssertErc20Tx | SuiTxReceivers | BtcTxReceivers | SourceIpAllowlist | SolanaInstructionPolicy | BtcSegwitValueLimit | RequireMfa | RequireRoleSession;
/**
 * Key policy
 *
 * @example [
