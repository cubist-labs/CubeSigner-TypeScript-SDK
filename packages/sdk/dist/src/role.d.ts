...
export type KeyDenyPolicy = TxReceiver | TxDeposit | TxValueLimit | TxGasCostLimit | IfErc20Tx | AssertErc20Tx | SourceIpAllowlist | SolanaInstructionPolicy | BtcSegwitValueLimit | RequireMfa;
/**
 * Key policy
 *
 * @example [
