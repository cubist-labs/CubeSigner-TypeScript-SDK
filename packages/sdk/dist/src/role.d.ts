import type { ApiClient, ContractAddress, EvmTxCmp, SolanaTxCmp, KeyWithPoliciesInfo, MfaType, PageOpts, RoleInfo, Scope, SessionData, SessionLifetime, BabylonStakingRequest, OperationKind, MfaReceipts, CubeSignerResponse, Empty, RestrictedActionsMap, GetRoleKeyOptions, EditPolicy } from ".";
...
export type KeyDenyPolicy = TxReceiver | TxDeposit | TxValueLimit | TxGasCostLimit | IfErc20Tx | AssertErc20Tx | AssertTransferOnlyTx | AssertContractTx | SuiTxReceivers | BtcTxReceivers | SourceIpAllowlist | SolanaInstructionPolicy | BtcSegwitValueLimit | RequireMfa | RequireRoleSession | BabylonStaking | WebhookPolicy;
/**
 * Key policy
 *
 * @example [
...
export type KeyPolicyRule = KeyDenyPolicy | AllowRawBlobSigning | AllowDiffieHellmanExchange | AllowEip191Signing | AllowEip712Signing | AllowBtcMessageSigning | PolicyReference;
/** Role policy */
