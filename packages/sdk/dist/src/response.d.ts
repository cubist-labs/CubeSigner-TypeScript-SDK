import type { EnvInterface, MfaReceipts, MfaRequired } from "./index.ts";
import { CubeSignerClient, MultiRegionEnv } from "./index.ts";
import type { AcceptedResponse, AcceptedValue, SignDryRun, JsonRpcResponse, JsonRpcResult } from "./schema_types.ts";
/**
...
export declare class CubeSignerResponse<U> {
     ...
     * @internal
     */
    static create<U>(env: EnvInterface | MultiRegionEnv, requestFn: RequestFn<U>, mfaReceipt?: MfaReceipts): Promise<CubeSignerResponse<U>>;
    /**
     ...
     * @internal
     */
    static createForJsonRpc(env: EnvInterface | MultiRegionEnv, reqFn: RequestFn<JsonRpcResponse>, mfaReceipt?: MfaReceipts): Promise<CubeSignerResponse<JsonRpcResult>>;
    /**
