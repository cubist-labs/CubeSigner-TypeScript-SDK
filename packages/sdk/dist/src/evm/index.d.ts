import { type CubeSignerResponse, type Eip191SignRequest, type Eip712SignRequest, type EvmSignRequest, Key, type MfaRequestInfo, type EvmSignResponse, type CubeSignerClient, type MfaRequest } from "../index.ts";
...
export declare class EvmSigner {
     ...
     */
    handleMfa<U>(res: CubeSignerResponse<U>): Promise<U>;
}
