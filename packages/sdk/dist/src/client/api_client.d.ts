...
export declare class ApiClient extends BaseClient {
     ...
     */
    rpc(body: JsonRpcRequest, mfaReceipt?: MfaReceipts): Promise<CubeSignerResponse<schemas["JsonRpcResponse"]>>;
    /**
