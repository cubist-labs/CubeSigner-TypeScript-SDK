...
export declare class ApiClient extends BaseClient {
     ...
     */
    static oidcSessionCreate(env: EnvInterface, orgId: string, token: string, scopes: Array<Scope>, lifetimes?: RatchetConfig, mfaReceipt?: MfaReceipts, purpose?: string, headers?: HeadersInit): Promise<CubeSignerResponse<SessionData>>;
    /**
     ...
     * @returns The session data
     */
    static passkeyLoginComplete(env: EnvInterface, body: PasskeyAssertAnswer, purpose?: string | null, headers?: HeadersInit): Promise<SessionData>;
    /**
