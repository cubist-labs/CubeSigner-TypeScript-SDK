...
export declare class ApiClient extends BaseClient {
     ...
     */
    orgQueryAuditLog(body: AuditLogRequest, page?: PageOpts): Paginator<AuditLogResponse, AuditLogEntry[]>;
    /**
     * Query org metrics.
     *
     * @param body The query
