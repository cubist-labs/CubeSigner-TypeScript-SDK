...
export declare class ApiClient extends BaseClient {
     ...
     */
    withPreferredEnv(env: EnvInterface | undefined): ApiClient;
    /**
     ...
     */
    static initEmailOtpAuth(env: EnvInterface, orgId: string, email: string, headers?: HeadersInit): Promise<EmailOtpResponse>;
    /**
     ...
     */
    orgUpdate(request: UpdateOrgRequest, mfaReceipt?: MfaReceipts): Promise<CubeSignerResponse<UpdateOrgResponse>>;
    /**
     ...
     */
    orgQueryAuditLog(body: AuditLogRequest, page?: PageOpts): Paginator<ValidatedAuditLogResponse, AuditLogEntry[]>;
    /**
     ...
     */
    orgQueryAuditLogRaw(body: AuditLogRequest, page?: PageOpts): Paginator<AuditLogResponse, AuditLogResponse["entries"]>;
    /**
     * Query org metrics.
     *
     * @param body The query
     ...
     */
    orgGetEmailConfig(purpose: EmailTemplatePurpose): Promise<schemas["GetEmailConfigResponse"]>;
    /**
     ...
     * @returns An empty response
     */
    orgDeleteEmailConfig(purpose: EmailTemplatePurpose): Promise<Empty>;
    /**
     ...
     * @returns An empty response
     */
    orgUserDelete(userId: string, opts?: DeleteUserOptions): Promise<Empty>;
    /**
     ...
     */
    orgUserCreateOidc(identityOrProof: OidcIdentity | IdentityProof | null, email?: string | null, opts?: CreateOidcUserOptions): Promise<string>;
    /**
     ...
     * @returns An empty response
     */
    orgUserDeleteOidc(identity: OidcIdentity, opts?: DeleteUserOptions): Promise<Empty>;
    /**
     * Get a key by its id.
     *
     ...
     */
    keyAttest(keyId: string, query?: KeyAttestationQuery): Promise<KeyInfoJwt>;
    /**
     ...
     */
    contactCreate(name: string, addresses?: AddressMap, metadata?: JsonValue, editPolicy?: EditPolicy, labels?: ContactLabel[]): Promise<ContactInfo>;
    /**
     ...
     */
    contactsList(page?: PageOpts, search?: `label:${ContactLabel}` | string): Paginator<ListContactsResponse, ContactInfo[]>;
    /**
     ...
     */
    contactLookupByAddress(address: ContactAddressData): Promise<ContactInfo[]>;
    /**
     ...
     * @returns A response which can be used to approve MFA if needed
     */
    contactDelete(contactId: string, mfaReceipt?: MfaReceipts): Promise<CubeSignerResponse<Empty>>;
    /**
     ...
     */
    contactUpdate(contactId: string, request: UpdateContactRequest, mfaReceipt?: MfaReceipts): Promise<CubeSignerResponse<ContactInfo>>;
    /**
     * Create a new role.
     *
     ...
     */
    roleAttest(roleId: string, query?: RoleAttestationQuery): Promise<RoleInfoJwt>;
    /**
     * Update a role.
     *
     ...
     */
    policyImportKeyCreate(): Promise<CreatePolicyImportKeyResponse>;
    /**
    ...
    policyCreate(name: string, type: PolicyType, rules: KeyPolicy | RolePolicy | {
        hash: string;
    }[], acl?: JsonValue[]): Promise<PolicyInfo>;
    /**
     ...
     */
    policiesList(page?: PageOpts, policyType?: PolicyType): Paginator<ListPoliciesResponse, PolicyInfo[]>;
    /**
     ...
     */
    policySecretSet(secretName: string, request: SetPolicySecretRequest, mfaReceipt?: MfaReceipts): Promise<CubeSignerResponse<PolicySecretsInfo>>;
    /**
     * Get org-level policy secrets.
     *
     * @returns The policy secrets info (names and ACLs only; values are not returned).
     */
    policySecretsGet(): Promise<PolicySecretsInfo>;
    /**
     ...
     * @returns The updated policy secrets info.
     */
    policySecretsUpdate(request: UpdatePolicySecretsRequest, mfaReceipt?: MfaReceipts): Promise<CubeSignerResponse<PolicySecretsInfo>>;
    /**
     ...
     * @returns The updated policy secrets info.
     */
    policySecretDelete(secretName: string, mfaReceipt?: MfaReceipts): Promise<CubeSignerResponse<PolicySecretsInfo>>;
    /**
     ...
     */
    bucketGet(bucketName: string): Promise<BucketInfo>;
    /**
     ...
     */
    bucketUpdate(bucketName: string, request: UpdateBucketRequest, mfaReceipt?: MfaReceipts): Promise<CubeSignerResponse<BucketInfo>>;
    /**
     ...
     */
    getCustomerProof(aud: "mmi" | "cube-pay" | string): Promise<string>;
    /**
     ...
     */
    rpc(body: JsonRpcRequest, mfaReceipt?: MfaReceipts): Promise<CubeSignerResponse<JsonRpcResult>>;
    /**
     ...
     */
    static emailMyOrgs(env: EnvInterface, email: string, headers?: HeadersInit): Promise<{
        status: string;
    }>;
    /**
     ...
     */
    static oidcSessionCreate(env: EnvInterface | MultiRegionEnv, orgId: string, token: string, scopes: Array<Scope>, lifetimes?: RatchetConfig, mfaReceipt?: MfaReceipts, purpose?: string, headers?: HeadersInit): Promise<CubeSignerResponse<SessionData>>;
    /**
     ...
     */
    static siweLoginInit(env: EnvInterface, orgId: string, body: schemas["SiweInitRequest"], headers?: HeadersInit): Promise<schemas["SiweInitResponse"]>;
    /**
     ...
     */
    static siweLoginComplete(env: EnvInterface, orgId: string, body: schemas["SiweCompleteRequest"], headers?: HeadersInit): Promise<schemas["SiweCompleteResponse"]>;
    /**
     ...
     */
    static siwsLoginInit(env: EnvInterface, orgId: string, body: schemas["SiwsInitRequest"], headers?: HeadersInit): Promise<schemas["SiwsInitResponse"]>;
    /**
     ...
     * @returns An OIDC token which can be used to log in via OIDC (see {@link oidcSessionCreate})
     */
    static siwsLoginComplete(env: EnvInterface, orgId: string, body: schemas["SiwsCompleteRequest"], headers?: HeadersInit): Promise<schemas["SiwsCompleteResponse"]>;
    /**
     ...
     */
    static passkeyLoginInit(env: EnvInterface | MultiRegionEnv, body: LoginRequest, headers?: HeadersInit): Promise<PasskeyLoginChallenge>;
    /**
     ...
     * @returns The session data
     */
    static passkeyLoginComplete(env: EnvInterface | MultiRegionEnv, body: PasskeyAssertAnswer, purpose?: string | null, headers?: HeadersInit): Promise<SessionData>;
    /**
     ...
     * @param headers Optional headers to set
     */
    static idpAcceptInvite(env: EnvInterface, orgId: string, body: InvitationAcceptRequest, headers?: HeadersInit): Promise<void>;
    /**
     ...
     */
    static idpAuthenticate(env: EnvInterface, orgId: string, body: AuthenticationRequest, headers?: HeadersInit): Promise<AuthenticationResponse>;
    /**
     ...
     */
    static idpPasswordResetRequest(env: EnvInterface, orgId: string, body: PasswordResetRequest, headers?: HeadersInit): Promise<EmailOtpResponse>;
    /**
     ...
     * @param headers Optional headers to set
     */
    static idpPasswordResetConfirm(env: EnvInterface, orgId: string, partialToken: string, signature: string, newPassword: string, headers?: HeadersInit): Promise<void>;
    /**
     ...
     * @returns Proof of authentication
     */
    static identityProveOidc(env: EnvInterface, orgId: string, token: string, headers?: HeadersInit): Promise<IdentityProof>;
    /**
     ...
     */
    static userOrgs(env: EnvInterface, token: string, headers?: HeadersInit): Promise<UserOrgsResponse>;
    /**
