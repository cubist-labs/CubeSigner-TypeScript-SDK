...
export declare class ApiClient extends BaseClient {
     ...
     */
    sessionCreateExtended(purpose: string, scopes: Scope[], lifetime: SessionLifetime, mfaReceipt?: MfaReceipt): Promise<CubeSignerResponse<SessionData>>;
    /**
     ...
     */
    signBtcMessage(key: Key | string, req: BtcMessageSignRequest, mfaReceipt?: MfaReceipt): Promise<CubeSignerResponse<BtcMessageSignResponse>>;
    /**
     ...
     * @return {Promise<BtcSignResponse | AcceptedResponse>} The response.
     */
    signPsbt(key: Key | string, req: PsbtSignRequest, mfaReceipt?: MfaReceipt): Promise<CubeSignerResponse<PsbtSignResponse>>;
    /**
