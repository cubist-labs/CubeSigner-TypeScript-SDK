...
import type { KeyInfo, SchemaKeyType, KeyInRoleInfo, EvmSignRequest, EvmSignResponse, Eip191SignRequest, Eip712SignRequest, Eth2SignRequest, Eth2UnstakeRequest, AvaTx, BlobSignRequest, BtcSignRequest, SolanaSignRequest, SolanaSignResponse, BtcMessageSignResponse, BtcSignResponse, BlobSignResponse, AvaSignResponse, Eth2UnstakeResponse, Eth2SignResponse, Eip191Or712SignResponse, PsbtSignRequest, PsbtSignResponse, DiffieHellmanResponse, KeyInfoJwt, KeyAttestationQuery, KeyPropertiesPatch } from "./schema_types.ts";
import type { ApiClient, AvaChain, BabylonRegistrationRequest, BabylonRegistrationResponse, BabylonStakingRequest, BabylonStakingResponse, CubeSignerResponse, EditPolicy, Empty, HistoricalTx, JsonValue, MfaReceipts, SuiSignRequest, SuiSignResponse } from "./index.ts";
...
/** HmacSha256 key type */
export declare const HmacSha256: "HmacSha256";
...
export declare const BabyJubjub: "BabyJubjub";
...
export declare class Key {
     ...
     */
    attest(query?: KeyAttestationQuery): Promise<KeyInfoJwt>;
     ...
     */
    diffieHellmanExchange(points: Uint8Array[], publicKey: CryptoKey, mfaReceipt?: MfaReceipts): Promise<CubeSignerResponse<DiffieHellmanResponse>>;
    /**
