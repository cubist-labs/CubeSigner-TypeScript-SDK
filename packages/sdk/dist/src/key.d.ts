...
import type { ApiClient, AvaChain, CubeSignerResponse, HistoricalTx, JsonValue, MfaReceipt } from ".";
...
export declare class Key {
     ...
     */
    signPsbt(req: PsbtSignRequest, mfaReceipt?: MfaReceipt): Promise<CubeSignerResponse<PsbtSignResponse>>;
    /**
     ...
     * @property { MfaReceipt } mfaReceipt Optional MFA receipt
     */
    /**
