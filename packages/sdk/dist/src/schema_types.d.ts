...
import type { AuditLogEntry } from "./audit_log.ts";
...
export declare const ALL_OPERATION_KINDS: readonly OperationKind[];
export type AcceptedValueCode = schemas["AcceptedValueCode"];
export declare const ALL_ACCEPTED_CODES: readonly AcceptedValueCode[];
...
export type KeyAttestationQuery = paths["/v0/org/{org_id}/keys/{key_id}/attest"]["get"]["parameters"]["query"];
export type RoleInfoJwt = schemas["RoleInfoJwt"];
export type RoleAttestationClaims = schemas["RoleAttestationClaims"];
export type RoleAttestationQuery = paths["/v0/org/{org_id}/roles/{role_id}/attest"]["get"]["parameters"]["query"];
...
export type MmiJrpcMethod = "custodian_listAccounts" | "custodian_listAccountsSigned" | "custodian_listAccountChainIds" | "custodian_createTransaction" | "custodian_sign" | "custodian_signTypedData" | "custodian_getSignedMessageById" | "custodian_getTransactionById" | "custodian_getCustomerProof" | "custodian_replaceTransaction" | "custodian_getTransactionLink" | "custodian_getSignedMessageLink";
...
/**
 * An {@link AuditLogResponse} whose `entries` have been validated against
 * `auditLogEntrySchema` (invalid rows dropped). This is what the audit-log
 * paginator yields from every fetch method.
 */
export type ValidatedAuditLogResponse = Omit<AuditLogResponse, "entries"> & {
...
export type DeleteUserOptions = operations["deleteUser"]["parameters"]["query"];
 ...
 */
export declare function coercePolicyInfo(p: schemas["PolicyInfo"]): PolicyInfo;
