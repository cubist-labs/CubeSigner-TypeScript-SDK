...
export declare class CubeSignerClient {
     ...
     */
    get resetEmail(): (email: string | import("./schema_types").schemas["EmailResetRequest"], mfaReceipt?: MfaReceipts) => Promise<CubeSignerResponse<import("./mfa").ResetEmailChallenge>>;
    /**
