...
import type { EnvInterface, MfaReceipts, SessionData, SessionInfo, SessionManager } from "./index.ts";
...
export declare class CubeSignerClient {
     ...
     */
    withPreferredEnv(env: EnvInterface | undefined): CubeSignerClient;
    /**
     ...
     */
    get user(): () => Promise<import("./schema_types.ts").UserInfo>;
    /**
     ...
     */
    get addFido(): (name: string | import("./schema_types.ts").schemas["FidoCreateRequest"], mfaReceipt?: MfaReceipts) => Promise<import("./response.ts").CubeSignerResponse<AddFidoChallenge>>;
    /**
     ...
     */
    get deleteFido(): (fidoId: string, mfaReceipt?: MfaReceipts) => Promise<import("./response.ts").CubeSignerResponse<import("./schema_types.ts").Empty>>;
    /**
     ...
     */
    get resetTotp(): (issuer?: string, mfaReceipt?: MfaReceipts) => Promise<import("./response.ts").CubeSignerResponse<TotpChallenge>>;
    /**
     ...
     */
    get resetEmail(): (req: string | import("./schema_types.ts").schemas["EmailResetRequest"], mfaReceipt?: MfaReceipts) => Promise<import("./response.ts").CubeSignerResponse<import("./mfa.ts").ResetEmailChallenge>>;
    /**
     ...
     */
    get deleteTotp(): (mfaReceipt?: MfaReceipts) => Promise<import("./response.ts").CubeSignerResponse<import("./schema_types.ts").Empty>>;
    /**
    ...
    get addEventListener(): <E extends "error" | "user-mfa-failed" | "session-expired">(event: E, listener: {
        "user-mfa-failed": (ev: import("./client/base_client.ts").UserMfaFailedEvent) => void;
        "session-expired": (ev: import("./index.ts").SessionExpiredEvent) => void;
        error: (ev: import("./index.ts").ErrorEvent) => void;
    }[E]) => ApiClient;
    /**
