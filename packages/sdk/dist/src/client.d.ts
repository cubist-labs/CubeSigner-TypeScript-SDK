...
import { Org } from "./org";
import type { CubeSignerResponse, EnvInterface, Scope, SessionData, SessionManager } from ".";
import { Key } from ".";
...
export declare class CubeSignerClient {
     ...
     */
    static createOidcSession(env: EnvInterface, orgId: string, token: string, scopes: Array<Scope>, lifetimes?: RatchetConfig, mfaReceipt?: MfaReceipt, purpose?: string): Promise<CubeSignerResponse<SessionData>>;
    /**
     ...
     */
    get addFido(): (name: string, mfaReceipt?: MfaReceipt) => Promise<CubeSignerResponse<AddFidoChallenge>>;
    /**
     ...
     */
    get deleteFido(): (fidoId: string, mfaReceipt?: MfaReceipt) => Promise<CubeSignerResponse<import("./schema_types").Empty>>;
    /**
     ...
     */
    get resetTotp(): (issuer?: string, mfaReceipt?: MfaReceipt) => Promise<CubeSignerResponse<TotpChallenge>>;
    /**
     ...
     */
    get deleteTotp(): (mfaReceipt?: MfaReceipt) => Promise<CubeSignerResponse<import("./schema_types").Empty>>;
    /**
