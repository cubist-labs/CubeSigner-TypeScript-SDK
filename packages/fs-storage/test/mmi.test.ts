 ...
 * @param {CubeSignerClient} client The cubesigner client.
 ...
 * @return {PendingMessageInfo} the pending message info.
 */
 ...
 * @param {CubeSignerClient} client the cubesigner client
 * @param {string} messageId the ID of the message to check
 * @param {string} messageField The name of the field to check for status
 */
