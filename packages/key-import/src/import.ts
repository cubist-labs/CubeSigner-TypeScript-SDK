...
export class KeyImporter {
   ...
   * @param { ImportDeriveKeyProperties } props Additional options for import
   ...
   *
   * @param { KeyType } keyType The type of key to import
   * @param { Uint8Array[] } secrets The secret keys to import.
   * @param { ImportDeriveKeyProperties } props Additional options for import
   * @return { Promise<Key[]> } `Key` objects for each imported key.
   */
   ...
   *
   * @param { KeyType } keyType The type of key to import
   * @param { Uint8Array[] } packages The key packages to import.
   * @param { ImportDeriveKeyProperties } props Additional options for import
   * @return { Promise<Key[]> } `Key` objects for each imported key.
   */
