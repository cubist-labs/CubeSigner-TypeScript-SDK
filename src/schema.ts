...
export interface paths {
  ...
  "/v0/org/{org_id}/mfa/{mfa_id}/fido": {
    /**
     * Approve an MFA Request with FIDO
     * @description Approve an MFA Request with FIDO
     *
...
export interface components {
  schemas: {
    ...
    /** @enum {string} */
    KeyType: "SecpEthAddr" | "SecpBtc" | "SecpAvaAddr" | "SecpBtcTest" | "BlsPub" | "BlsInactive" | "Ed25519SolanaAddr" | "Ed25519SuiAddr" | "Ed25519AptosAddr" | "Ed25519CardanoAddrVk" | "Mnemonic" | "Stark";
    KeyWithPolicies: {
      /**
       * @description Key ID
       * @example Key#0x8e3484687e66cdd26cf04c3647633ab4f3570148
