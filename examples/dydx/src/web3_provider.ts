...
import { KeyInfo, SignerSession, ethers as csEthers } from "@cubist-labs/cubesigner-sdk";
...
export class Web3Provider implements AbstractProvider {
   ...
   * @return {csEthers.Signer} Signer for that address
   */
  #newSigner(address: string): csEthers.Signer {
    address = address.toLowerCase();
    return new csEthers.Signer(
