    ...
    SolanaInstructionPolicy: {
      required: [
        ...
        },
        {
          ...
          accounts: [
            {
              address: transferInfo.accounts[1],
              index: 1,
            },
          ],
        },
 ...
 * @param material_id the material id of the key to sign the message with.
 ...
 *
 * @param policy the policy to add to the key.
 * @param material_id the material id of the key to add the policy to.
 */
 ...
 * SolanaInstructionPolicy.
 *
 * @param message the compiled Solana transaction.
 * @param instruction_idx the index of the instruction to get the information for.
 * @returns an object containing the `programId` of the instruction's program,
