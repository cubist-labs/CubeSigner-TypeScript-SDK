...
import type { BbnNetworkId } from "./types";
import { isBbnNetworkId, HEX_REGEX } from "./types";

/**
 * The information needed to create a deposit
 */
export type UnbondPhase1Info = {
...
/**
 * UnbondPhase1Info type guard
 *
 * @param val The data to check
 * @returns Whether the value is of the correct type
 */
export function isUnbondPhase1Info(val: unknown): val is UnbondPhase1Info {
  if (val === undefined) return false;
  const info = val as UnbondPhase1Info;
