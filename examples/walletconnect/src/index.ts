...
const RPC_PROVIDER = env("RPC_PROVIDER", "https://rpc.ankr.com/eth_sepolia");
 ...
 * key.
 *
 * @param {string} keyId The key id of the EVM key used.
 * @param {string} rpcProvider A provider for sending a Sepolia transaction to the chain
 * @param {string} signerToken A CubeSigner token for a signer session
 * @return {Promise<[Key, Signer]>} A CubeSigner key and an Ether's Signer configured to use this key
 */
 ...
 * @param {Key} key The CubeSigner key
 * @param {Signer} signer A CubeSigner Ethers signer used to submit transactions
 * @return {Promise<IWeb3Wallet>} A Web3Wallet with event handlers for
 ...
 *
 * @param {IWeb3Wallet} web3Wallet The wallet receiving the session proposal
 * @param {Key} key The CubeSigner key used by the wallet
 */
 ...
 *
 * @param {IWeb3Wallet} web3Wallet The wallet receiving the session request
 * @param {Key} key The CubeSigner key used by the wallet for signing
 * @param {Web3WalletTypes.SessionRequest} obj The parameters handed by the dapp for the request
 */
async function personalSign(
  web3Wallet: IWeb3Wallet,
  key: Key,
  { topic, params, id }: Web3WalletTypes.SessionRequest,
) {
 ...
 *
 * @param {IWeb3Wallet} web3Wallet The wallet receiving the session request
 * @param {Signer} signer A CubeSigner Ethers signer used to submit the transaction
 * @param {Web3WalletTypes.SessionRequest} obj The parameters handed by the dapp for the request
 */
 ...
 *
 * @param {string} message The reason the request is rejected
 * @param {IWeb3Wallet} web3Wallet The wallet used for the request
 * @param {number} id The id of the request being rejected
 * @param {string} topic The identifier for the session between the wallet and the dapp
 */
 ...
 *
 * @param {IWeb3Wallet} web3Wallet The WalletConnect instance
 */
 ...
 * @param {string} fallback An optional fallback value.
 ...
 * @return {Promise<boolean>} if the user says Y/y, yes, or hits enter to the Y/n prompt
 */
