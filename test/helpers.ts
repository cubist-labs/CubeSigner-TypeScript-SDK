...
import { CubeSigner, Org, SignerSessionManager } from "../src";
 ...
 * then calls `cs.oidcProve`, and finally restores the org policy to what it originally was.
 *
 ...
 */
export async function oidcProve(cs: CubeSigner, oidcToken: string, org: Org) {
  return withOidcAuthSourcesPolicy(oidcToken, org, () => cs.oidcProve(oidcToken, org.id));
}
